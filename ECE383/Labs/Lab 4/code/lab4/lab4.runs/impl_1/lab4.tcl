...
set rc [catch {
  ...
  add_files -quiet {{C:/Users/C19Mark.Demore/Documents/Demore_ECE383/Labs/Lab 4/code/lab4/lab4.runs/synth_1/lab4.dcp}}
...
set rc [catch {
  ...
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -file lab4_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -file lab4_timing_summary_routed.rpt -warn_on_violation  -rpx lab4_timing_summary_routed.rpx"
