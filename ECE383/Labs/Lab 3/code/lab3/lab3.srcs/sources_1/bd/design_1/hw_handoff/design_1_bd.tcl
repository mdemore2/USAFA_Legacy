...
proc create_root_design { parentCell } {
  ...
  # Create instance: lab2_0, and set properties
  set lab2_0 [ create_bd_cell -type ip -vlnv af.edu:user:lab2:1.0 lab2_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins lab2_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_ports scl] [get_bd_pins lab2_0/scl]
  connect_bd_net -net Net1 [get_bd_ports sda] [get_bd_pins lab2_0/sda]
  connect_bd_net -net ac_adc_sdata_0_1 [get_bd_ports ac_adc_sdata] [get_bd_pins lab2_0/ac_adc_sdata]
  ...
  connect_bd_net -net lab2_0_ac_bclk [get_bd_ports ac_bclk] [get_bd_pins lab2_0/ac_bclk]
  connect_bd_net -net lab2_0_ac_dac_sdata [get_bd_ports ac_dac_sdata] [get_bd_pins lab2_0/ac_dac_sdata]
  connect_bd_net -net lab2_0_ac_lrclk [get_bd_ports ac_lrclk] [get_bd_pins lab2_0/ac_lrclk]
  connect_bd_net -net lab2_0_ac_mclk [get_bd_ports ac_mclk] [get_bd_pins lab2_0/ac_mclk]
  connect_bd_net -net lab2_0_ready [get_bd_pins lab2_0/ready] [get_bd_pins microblaze_0/Interrupt]
  connect_bd_net -net lab2_0_tmds [get_bd_ports tmds] [get_bd_pins lab2_0/tmds]
  connect_bd_net -net lab2_0_tmdsb [get_bd_ports tmdsb] [get_bd_pins lab2_0/tmdsb]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_smc/aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins lab2_0/s00_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs lab2_0/S00_AXI/S00_AXI_reg] SEG_lab2_0_S00_AXI_reg
