...
proc create_root_design { parentCell } {
  ...
  set My_Counter_IP_0 [ create_bd_cell -type ip -vlnv af.edu:user:My_Counter_IP:1.0 My_Counter_IP_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M02_AXI [get_bd_intf_pins My_Counter_IP_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M02_AXI]
