...
HD_PWD='C:/Users/C19Mark.Demore/Documents/Demore_ECE383/Homework/HW2/hw2/hw2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scancodeDecoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scancodeDecoder.tcl
