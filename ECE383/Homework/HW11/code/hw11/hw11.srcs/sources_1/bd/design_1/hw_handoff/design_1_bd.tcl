...
proc create_root_design { parentCell } {
  ...
  set my_counter_ip_0 [ create_bd_cell -type ip -vlnv af.edu:user:my_counter_ip:2.0 my_counter_ip_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI] [get_bd_intf_pins my_counter_ip_0/S00_AXI]
  ...
  connect_bd_net -net my_counter_ip_0_LED [get_bd_ports LED_1] [get_bd_pins my_counter_ip_0/LED]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins my_counter_ip_0/s00_axi_aresetn] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs my_counter_ip_0/S00_AXI/S00_AXI_reg] SEG_my_counter_ip_0_S00_AXI_reg
