...
HD_PWD='C:/Users/C19Mark.Demore/Documents/Demore_ECE383/lsn1/lsn1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log majority.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source majority.tcl
