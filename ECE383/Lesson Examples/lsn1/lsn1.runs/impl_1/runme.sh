...
HD_PWD='C:/Users/C19Mark.Demore/Documents/Demore_ECE383/lsn1/lsn1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log majority.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source majority.tcl -notrace
